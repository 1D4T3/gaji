        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-header">
                    ...
                    {{-- <a href="{{ route('lokasi._excel') }}" class="btn btn-info btn-md float-right mr-1"> Export Excel</a>
                   <a href="{{ route('lokasi._pdf') }}" class="btn btn-success btn-md float-right mr-1"> Print Lokasi</a>
                    <a href="{{ route('lokasi.chart') }}" class="btn btn-warning btn-md float-right mr-1"> Grafik Lokasi</a> --}}
                </div>
